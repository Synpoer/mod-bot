...
module.exports.run = (client, message, args) => {
    ...
    try {
        ...
        message.reply('votre candidature a bien été envoyée au staff du serveur. Vous recevrez un réponse quand le staff aura étudié votre candidature.')
            ...
            .catch((error) => {
                console.error(error);
                message.channel.send('Une erreur s\'est produite lors de l\'exécution de la commande. Veuillez réessayer ultérieurement. Si le problème persiste, veuillez contacter love/tempo#6806.');
            });
